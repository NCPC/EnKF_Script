...
#Read the date from the rpointer.drv 
cplfile=`head -1 rpointer.drv | awk '{print $1}'`
date_rst=`echo $cplfile | tail -20c`
year_rst=`echo $date_rst | head -4c`
month_rst=`echo $date_rst | cut -c6-7`
if [ $month_rst == 01 ] ; then
   let year_h_rst=year_rst-1
   let month_h_rst=12 
else
   let year_h_rst=year_rst
   month_h_rst=`expr $month_rst - 1` 
   month_h_rst=$(echo 0$month_h_rst | tail -c3 )
fi
set ${CASE}.cpl.r.*
...
set ${CASE}.cam?.r.*;        latest=`ls ${CASE}.cam?.r.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/rest $*
set ${CASE}.cam?.rs.*;       latest=`ls ${CASE}.cam?.rs.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/rest $*
#set ${CASE}.cam?.ra.*;       latest=`ls -rt $* 2> /dev/null | tail -1`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/rest $*
set ${CASE}.cam?.rh0.*;      latest=`ls ${CASE}.cam?.rh0.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/rest $*
set ${CASE}.cam?.rh1.*;      latest=`ls ${CASE}.cam?.rh1.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/rest $*
set ${CASE}.cam?.rh2.*;      latest=`ls ${CASE}.cam?.rh2.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/rest $*
set ${CASE}.cam?.rh3.*;      latest=`ls ${CASE}.cam?.rh3.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/rest $*
set ${CASE}.cam?.rh4.*;      latest=`ls ${CASE}.cam?.rh4.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/rest $*
set ${CASE}.cam?.rh5.*;      latest=`ls ${CASE}.cam?.rh5.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/rest $*
set ${CASE}.cam?.i.*;        latest=`ls ${CASE}.cam?.i.${year_rst}-01-01-00000.nc`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/atm/init $*
set ${CASE}.cam?.h0.*;       latest=`ls ${CASE}.cam?.h0.${year_h_rst}-${month_h_rst}.nc`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
#set ${CASE}.cam?.h1.*;       latest=`grep -P '.h1' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
#set ${CASE}.cam?.h2.*;       latest=`grep -P '.h2' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
#set ${CASE}.cam?.h3.*;       latest=`grep -P '.h3' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
#set ${CASE}.cam?.h4.*;       latest=`grep -P '.h4' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
#set ${CASE}.cam?.h5.*;       latest=`grep -P '.h5' ${sta}/rest/${dname}/rpointer.atm 2> /dev/null | sed 's/#//'`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*
set ${CASE}.cam?.h1.*;       latest=`ls *.h1* | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*                                                                               
set ${CASE}.cam?.h2.*;       latest=`ls *.h2* | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $* 
set ${CASE}.cam?.h3.*;       latest=`ls *.h3* | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*                                                                             
set ${CASE}.cam?.h4.*;       latest=`ls *.h4* | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*                                                                             
set ${CASE}.cam?.h5.*;       latest=`ls *.h5* | tail -1`; $CP $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/atm/hist $*

set ${CASE}.clm?.r.*;        latest=`ls ${CASE}.clm?.r.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh0.*;      latest=`ls ${CASE}.clm?.rh0.${date_rst}`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh1.*;      latest=`ls ${CASE}.clm?.rh1.${date_rst}`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh2.*;      latest=`ls ${CASE}.clm?.rh2.${date_rst}`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh3.*;      latest=`ls ${CASE}.clm?.rh3.${date_rst}`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh4.*;      latest=`ls ${CASE}.clm?.rh4.${date_rst}`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*
set ${CASE}.clm?.rh5.*;      latest=`ls ${CASE}.clm?.rh5.${date_rst}`; mv $latest ${sta}/rest/${dname} 2>  /dev/null; dispose ifiles_y ${sta}/lnd/rest $*

set ${CASE}.clm?.h0.*;       latest=`ls ${CASE}.clm?.h0.${year_rst}-01-01-00000.nc`; ${CP} $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_n ${sta}/lnd/hist $*
...
set ${CASE}.cice.r.[0-9]*;   latest=`ls ${CASE}.cice.r.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/ice/rest $*
...
set ${CASE}.cpl.r.*;         latest=${cplfile}; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/cpl/rest $*
set ${CASE}.cpl.h* ;                                                                                                  dispose ifiles_n ${sta}/cpl/hist $*

set ${CASE}.micom.r.*;       latest=`ls ${CASE}.micom.r.${date_rst}`; mv $latest ${sta}/rest/${dname} 2> /dev/null; dispose ifiles_y ${sta}/ocn/rest $*
...
#copy back the required files for next restart (do copying on backend of hexagon)
$CP ${sta}/rest/${dname}/* .
