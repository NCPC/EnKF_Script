...
CASEDIR="noresm1_me_hist_s01_analysis"
export metdata_path=/work/shared/nn9039k/CAM_Nudging/met_data
export CAM_Max_rlx=0.08333333333333333

ParentP="noresm1_me_hist_s01"

WORKDIR=/work/${USER}/noresm/${ParentP}
ARCHIVE=/work/${USER}/archive/${ParentP}
if [ "$CASEDIR" == "NorCPM_ME" ] ; then
   ...
   RES=f19_g16 
   #The following are necessary to set path to the miseryous cam2.i file 
   ifile_casename=NorCPM_ME_mem
   ifile_date=1981-01-01-00000
fi
...
ens_start_date=1981-01-15-00000    # MS testing ...
...
start_date=1981-01-15-00000  # MS testing ...
