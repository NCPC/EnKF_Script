...
yr_start=1970;
yr_end=1970;
parea=ncread('grid.nc','parea');
rec=0;
for yr=yr_start:yr_end
   for mm=1:12
      if exist([num2str(yr) '_' num2str(mm,'%2.2d') '/observations-SST.nc'], 'file') == 2
       ipiv=ncread([num2str(yr) '_' num2str(mm,'%2.2d') '/observations-SST.nc'],'ipiv');
       jpiv=ncread([num2str(yr) '_' num2str(mm,'%2.2d') '/observations-SST.nc'],'jpiv');
       inov=ncread([num2str(yr) '_' num2str(mm,'%2.2d') '/observations-SST.nc'],'innovation');
       d=ncread([num2str(yr) '_' num2str(mm,'%2.2d') '/observations-SST.nc'],'d');
       obs_var=ncread([num2str(yr) '_' num2str(mm,'%2.2d') '/observations-SST.nc'],'var');
       mod_var=ncread([num2str(yr) '_' num2str(mm,'%2.2d') '/observations-SST.nc'],'forecast_variance');
